...
namespace test_edc_popover_dotnet
{
    ...
    public partial class App : Application
    {
        ...
        private static void SetupGui(Window mainWindow)
        {
            ...
            EdcHelpSingletonGui.GetInstance().SetIconState(IconState.DISABLED);
            ...
            wrapHelpIconPanel.Children.Add(EdcHelpSingletonGui.GetInstance().CreateComponent("fr.techad.edc", "help.cengerter"));
